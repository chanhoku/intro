...
export const Profile = () => {
    return(
        <section id="profile" className="py-24 bg-main text-white">
            <h2 className="text-5xl text-center font-semibold">profile</h2>
            <div className="flex justify-center justify-items-center items-center mt-12">
                <div>
                ...
                <div className="w-44 ml-12 border-4"><img src={profileicon} alt="profileicon"/></div>
            </div>
        </section>
    );
};